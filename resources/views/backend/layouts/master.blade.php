...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ route('dashboard.home') }}" class="logo">
            ...
            <span class="logo-mini"><b>CCL</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>CCL</b></span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            Built with <i class="fa fa-fw fa-heart"></i>
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; {!! date('Y') !!} <a href="#">CCL</a>.</strong> All rights reserved.
    </footer>
