            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Create court</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        @include('backend.partials.message')
                        <form role="form" action="{{ route('backend.court.store') }}" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="address" id="address" class="form-control textarea" cols="30" rows="10">{{ old('address') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="open_hour" class="col-sm-2 control-label">Open hours</label>
                                <div class="col-sm-10">
                                    <input type="text" name="open_hour" class="form-control" id="open_hour" placeholder="Open hour" value="{{ old('open_hour') }}" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="website" class="form-control" id="website" placeholder="Website" value="{{ old('website') }}" />
                                </div>
                            </div>
                            <div class="form-group">
